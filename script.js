...
const USERS = [
    { username: "braxei", password: "2323beat2323", expiresAt: new Date("2027-04-30") },
    { username: "trcsnn", password: "2323beat2323", expiresAt: new Date("2027-04-30") },
    { username: "mrass", password: "2323beat2323", expiresAt: new Date("2027-04-30") },
    { username: "trixms", password: "2323beat2323", expiresAt: new Date("2027-04-30") },
    { username: "dred", password: "2323beat2323", expiresAt: new Date("2027-04-30") },
    { username: "gregd", password: "2323beat2323", expiresAt: new Date("2027-04-30") },
    { username: "monitor", password: "2323beat2323", expiresAt: new Date("2027-04-30") },
    { username: "miuser", password: "2323beat2323", expiresAt: new Date("2027-04-30") },
    { username: "elios", password: "2323beat2323", expiresAt: new Date("2027-04-30") },
    { username: "mora", password: "2323beat2323", expiresAt: new Date("2026-05-08") },
    { username: "soles", password: "2323beat2323", expiresAt: new Date("2026-05-07") },
    { username: "brenda", password: "2323beat2323", expiresAt: new Date("2027-04-30") },
    { username: "relox", password: "2323beat2323", expiresAt: new Date("2027-05-10") },
    { username: "cuare", password: "2323beat2323", expiresAt: new Date("2027-04-30") }
];
